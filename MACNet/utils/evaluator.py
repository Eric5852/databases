...
class Eval_thread():
    ...
    def run(self):
        ...
        #self.LOG('{} data with {} method get {:.4f} mae, {:.4f} max-fmeasure, {:.4f} max-Emeasure, {:.4f} S-measure..\n'.format(self.data, self.method, mae, max_f, max_e, s))
        #return '[cost:{:.4f}s]{} data with {} method get {:.4f} mae, {:.4f} max-fmeasure, {:.4f} max-Emeasure, {:.4f} S-measure..'.format(time.time()-start_time, self.data, self.method, mae, max_f, max_e, s)
    
    def Eval_mae(self):
        #print('eval[MAE]:{} data with {} method.'.format(self.data, self.method))
    ...
    def Eval_fmeasure(self):
        print('eval[FMeasure]:{} data with {} method.'.format(self.dataset, self.method))
        beta2 = 0.3
    ...
    def Eval_Emeasure(self):
        print('eval[EMeasure]:{} data with {} method.'.format(self.dataset, self.method))
    ...
    def Eval_Smeasure(self):
        #print('eval[SMeasure]:{} data with {} method.'.format(self.data, self.method))
